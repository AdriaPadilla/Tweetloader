.. user_tweet_downloader documentation master file, created by
   sphinx-quickstart on Tue Jan 21 20:34:28 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to user_tweet_downloader's documentation!
=================================================
...
App Auth have a 1.500 requests limit in a 15 min window. We can translate this in:
...
More information about GET statuses/user_timeline
